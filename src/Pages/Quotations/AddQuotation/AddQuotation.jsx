...
import { Add, ArrowBack, Search, Delete , Close } from "@mui/icons-material";
...
function AddQuotation() {
  ...
  return (
    <>
      ...
      <div
        className={`bg-gray-100 absolute top-[115px] right-0 w-full h-full overflow-auto p-4 sm:p-6 md:p-8 lg:p-10  transition-all duration-300 ${isModalOpen ? "blur-sm" : ""}`}
      >
        <div className="bg-white p-6 rounded-md shadow-md w-full pb-[150px]">
          ...
          <div className="flex justify-end">
            ...
            <div className="w-full md:w-[500px] bg-gray-50 p-4 md:p-6 rounded-md shadow-md space-y-4">
              ...
              <hr />
              <div className="flex justify-between ">
                <span className="text-base md:text-lg text-[#264164]">
                  Total
                </span>
                <span className="text-base md:text-lg text-[#264164]">
                  (LKR) 0.00
