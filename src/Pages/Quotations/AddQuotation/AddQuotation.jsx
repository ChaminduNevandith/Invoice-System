...
<div className="flex flex-col sm:flex-row items-start sm:items-end sm:space-x-4 mb-8">
  ...
  <button className="w-[28px] h-[28px] 2xl:w-[40px] 2xl:h-[40px] xl:w-[40px] xl:h-[40px] lg:w-[30px] lg:h-[30px] sm:w-[28px] sm:h-[28px] md:w-[28px] md:h-[28px] mt-4 sm:mt-0 sm:ml-4 rounded-full bg-[#F9CD94] text-white hover:bg-[#FFA93A] flex items-center justify-center">
    <Add fontSize="small" />
        ...
        <div className="flex flex-col md:flex-row justify-between mb-8 text-[#264164]  text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-sm xxl:text-lg">
          ...
          <div>
            <div className="text-4xl font-semibold text-right">Quotation</div>
            ...
            <tbody>
              <tr className="border-t bg-[#FEF9FF] block md:table-row mb-4 md:mb-0">
                <td className="py-2 px-4 block md:table-cell">
                  <div className="md:hidden text-[#264164] font-semibold text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-sm xxl:text-lg">Item</div>
                ...
                <td className="py-2 px-4 block md:table-cell">
                  <div className="md:hidden text-[#264164] font-semibold text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-sm xxl:text-lg">Rate (LKR)</div>
                  0
                </td>
                <td className="py-2 px-4 block md:table-cell">
                  <div className="md:hidden text-[#264164] font-semibold text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-sm xxl:text-lg">Quantity</div>
                  <input
                    type="number"
                    defaultValue="1"
                ...
                <td className="py-2 px-4 block md:table-cell">
                  <div className="md:hidden text-[#264164] font-semibold text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-sm xxl:text-lg">Discount Type</div>
                  <select className="border rounded-md p-2 w-full text-[#264164] hover:ring-2 hover:ring-blue-300 hover:ring-opacity-50 ">
                    <option>%</option>
                ...
                <td className="py-2 px-4 block md:table-cell">
                  <div className="md:hidden text-[#264164] font-semibold text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-sm xxl:text-lg ">Discount</div>
                  <input
                    type="number"
                    defaultValue="0"
                    className="border rounded-md p-2 w-full text-[#264164] hover:ring-2 hover:ring-blue-300 hover:ring-opacity-50"
        ...
        <div className="flex space-x-4 mt-4 mb-6">
          <button className="border border-gray-300 text-gray-500 p-2 rounded-md hover:ring-2 hover:ring-blue-300 hover:ring-opacity-50  text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-sm xxl:text-lg">+ Add New Product Category</button>
          <button className="border border-gray-300 text-gray-500 p-2 rounded-md hover:ring-2 hover:ring-blue-300 hover:ring-opacity-50  text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-sm xxl:text-lg">+ Add New Item</button>
        </div>
  ...
  <div className="w-full md:w-[500px] bg-gray-50 p-4 md:p-6 rounded-md shadow-md space-y-4">
    <div className="flex justify-between">
      <span className="text-base md:text-lg text-[#264164] text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-sm xxl:text-lg">Subtotal</span>
      <span className="text-base md:text-lg text-[#264164] text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-sm xxl:text-lg">(LKR) 0.00</span>
    </div>
    <div className="flex justify-between items-center">
      <span className="text-base md:text-lg text-[#264164] text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-sm xxl:text-lg p-1">Discount</span>
      <div className="flex space-x-2">
        <input
          type="number"
          placeholder="Discount"
          className="w-[80px] md:w-[100px] p-1 md:p-2 border rounded-md border-gray-300 focus:ring-2 focus:ring-blue-500 transition-all duration-200 focus:ring-opacity-50 hover:ring-2 hover:ring-blue-300 hover:ring-opacity-50"
        />
        <select className="border rounded-md p-1 md:p-2 w-[60px] md:w-[80px] text-[#264164] hover:ring-2 hover:ring-blue-300 hover:ring-opacity-50">
          <option>%</option>
          <option>Amount</option>
        </select>
      </div>
    ...
    <hr />
    <div className="flex justify-between ">
      <span className="text-base md:text-lg text-[#264164]">Total</span>
      <span className="text-base md:text-lg text-[#264164]">(LKR) 0.00</span>
    </div>
  </div>
</div>
