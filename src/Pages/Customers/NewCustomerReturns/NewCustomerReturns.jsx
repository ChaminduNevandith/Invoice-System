...
function NewCustomerReturns() {
  ...
  <h1 className="text-2xl font-semibold text-[#264164] mb-1">Add Customer Return</h1>
...
<div className="flex flex-col sm:flex-row items-start sm:items-end sm:space-x-2 mb-8">
...
export default NewCustomerReturns;
