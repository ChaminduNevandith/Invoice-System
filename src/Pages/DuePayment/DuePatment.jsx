...
function ListCustomers() {
  ...
  const [customers, setCustomers] = useState([
    { id: 1, name: 'Akila Perera', contact: '0712345678', email: 'akila.perera@example.com', invoiceCount: 1, total: '6,500.00', status: 'Processed' },
    { id: 2, name: 'Akila Perera', contact: '0712345678', email: 'akila.perera@example.com', invoiceCount: 1, total: '6,500.00', status: 'Pending' },
    { id: 3, name: 'Akila Perera', contact: '0712345678', email: 'akila.perera@example.com', invoiceCount: 1, total: '6,500.00', status: 'Processed' },
  ]);
  ...
  return (
    <div className="bg-white p-6 rounded-md shadow-md w-full ">
      <h1 className="text-2xl font-semibold text-[#264164] mb-1">Due Payment</h1>
      ...
      <div className="flex flex-col md:flex-col lg:flex-row xl:flex-row 2xl:flex-row xxl:flex-row justify-between mb-4">
        ...
        <div className="relative mb-4 md:mb-0 pb-2">
            ...
            {/* Search Bar */}
            <div className="relative mb-4 md:mb-0 pb-2">
            <label className="block text-[#264164] mb-1 text-xs">Search By Salesman</label>
            <input 
                type="text" 
                placeholder="Search..." 
                className="text-[#264164] pl-10 p-2 border rounded-md w-full sm:w-full md:w-full lg:w-[150px] xl:w-[200px] 2xl:w-[200px] xxl:w-[200px] border-gray-300 focus:ring-2 focus:ring-blue-500 transition-all duration-200  focus:ring-opacity-50 hover:ring-2 hover:ring-blue-300 hover:ring-opacity-50"
        ...
        <label className="block text-[#264164] mb-1 text-xs">Select Date Type</label>
          <select className="text-[#264164] p-2 border rounded-md w-full sm:w-full md:w-full lg:w-[150px] xl:w-[200px] 2xl:w-[200px] xxl:w-[200px] border-gray-300 focus:ring-2 focus:ring-blue-500 transition-all duration-200 focus:ring-purple-500 focus:ring-opacity-50 hover:ring-2 hover:ring-blue-300 hover:ring-opacity-50">
            <option>All</option>
        ...
        <table className="table-auto w-full border-collapse text-xs
          ...
          <thead>
            <tr className="text-left text-gray-700 bg-[#F2F1F1]">
              ...
              <th className="py-2 px-4 border-b text-[#264164]">Salesman Name</th>
              ...
              <th className="py-2 px-4 border-b text-[#264164]">Payments</th>
              <th className="py-2 px-4 border-b text-[#264164]">Balance</th>
          ...
          <tbody>
            {customers.map((customer) => (
              <tr key={customer.id} className="table-row text-gray-700 text-left bg-[#FEF9FF] ">
                <td className="py-2 px-4 border-b text-[#264164]" data-label="Customer Name">{customer.name}</td>
                <td className="py-2 px-4 border-b text-[#264164]" data-label="Salesman Name">{customer.name}</td>
                ...
                <td className="py-2 px-4 border-b text-[#264164]" data-label="Payment (LKR)">{customer.total}</td>
                <td className="py-2 px-4 border-b text-[#264164]" data-label="Balance (LKR)">{customer.total}</td>
