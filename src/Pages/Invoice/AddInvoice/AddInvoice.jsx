...
import { Add, ArrowBack, Search, Delete, QrCode2 , Close } from "@mui/icons-material";
import { Tooltip } from "@mui/material";
import { NavLink } from "react-router-dom";
import Addcustomerform from "../../../Component/Addcustomerform/Addcustomerform";
...
function AddInvoice() {
  ...
  return (
    <>
      ...
      <div
        className={`bg-gray-100 absolute top-[115px] right-0 w-full h-full overflow-auto p-4 sm:p-6 md:p-8 lg:p-10 pb-[150px] transition-all duration-300 ${isModalOpen ? "blur-sm" : ""}`}
      >
        ...
        <div className="flex justify-end">
          ...
          <div className="w-full md:w-[500px] bg-gray-50 p-4 md:p-6 rounded-md shadow-md space-y-4">
            <div className="flex justify-between">
              <span className="text-base md:text-lg text-[#264164] text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-sm xxl:text-sm">
                Subtotal
              </span>
              <span className="text-base md:text-lg text-[#264164] text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-sm xxl:text-sm">
                (LKR) 0.00
            ...
            <div className="flex justify-between items-center">
              <span className="text-base text-[#264164] text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-sm xxl:text-sm p-1 ">
                Discount
              </span>
            ...
            <div className="flex justify-between ">
              <span className="text-base text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-sm xxl:text-sm text-[#264164]">
                Total
              </span>
              <span className="text-base text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-sm xxl:text-sm text-[#264164]">
                (LKR) 0.00
            ...
            <div className="flex justify-between items-center">
              <span className="text-base md:text-lg text-[#264164] text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-sm xxl:text-sm p-1">
                Payment Type
              </span>
              <div className="flex space-x-2 ">
