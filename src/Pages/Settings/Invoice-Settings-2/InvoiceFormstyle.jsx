        ...
        >
          <thead>
            <tr className="text-left text-gray-700 bg-[#F2F1F1]">
              ...
              <th className="py-2 px-4 border-b text-[#264164]">Form type</th>
              <th className="py-2 px-4 border-b text-[#264164]">Last Edited</th>
          ...
          <tbody>
            {customers.map((customer) => (
              ...
              >
                <td
                  className="py-2 px-4 border-b text-[#264164]"
...
export default InvoiceFormstyle;
