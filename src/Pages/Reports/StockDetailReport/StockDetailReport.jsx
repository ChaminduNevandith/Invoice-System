...
function ListGRN() {
  const [customers, setCustomers] = useState([
    { id: 1, Category: 'mobile phone', Description: '5', RealCost : '10000000',Cost : '10000000', Rate: '5' ,QtyType:"12",SIH:"111",TotalCost:"2000",TotalRate:"2000"},
    { id: 1, Category: 'Rubber seal', Description: '5', RealCost: '10000000',Cost : '10000000', Rate: '5',QtyType:"12",SIH:"111",TotalCost:"2000",TotalRate:"2000"},
    { id: 1, Category: 'Beverage', Description: '5', RealCost: '10000000',Cost : '10000000', Rate: '5',QtyType:"12",SIH:"111",TotalCost:"2000",TotalRate:"2000"},
    { id: 1, Category: 'HDP', Description: '5', RealCost: '10000000',Cost : '10000000', Rate: '5',QtyType:"12",SIH:"111",TotalCost:"2000",TotalRate:"2000"},
  ...
  return (
    <div className="bg-white p-6 rounded-md shadow-md w-full mb-[150px]">
      <div className="flex justify-center items-center mb-4">
        <h1 className="text-2xl font-semibold text-[#264164] mb-1">Stock Detail Report</h1>
      ...
      <div className="overflow-x-auto">
        <table className="table-auto w-full border-collapse text-xs
          ...
          <thead>
            <tr className="text-left text-gray-700 bg-[#F2F1F1] ">
                ...
                <th className="py-2 px-10 text-[#264164]">Real Cost </th>
                <th className="py-2 px-10 text-[#264164]">Cost</th>
                ...
                <th className="py-2 px-10 text-[#264164]">Total Cost</th>
                <th className="py-2 px-10 text-[#264164]">Total Rate</th>
            </tr>
          </thead>
          <tbody>
            {customers.map((customer) => (
              <tr key={customer.id} className="table-row text-gray-700 text-left  bg-[#FEF9FF]">
                ...
                <td className="py-2 px-10 border-b text-[#264164]" data-label="Description">
                  <p className="whitespace-normal break-words">{customer.Description}</p>
                </td>
                <td className="py-2 px-10 border-b text-[#264164]" data-label="Real Cost ">{customer.RealCost }</td>
                <td className="py-2 px-10 border-b text-[#264164]" data-label="Cost">{customer.Cost}</td>
                <td className="py-2 px-10 border-b text-[#264164]" data-label="Rate">{customer.Rate}</td>
                <td className="py-2 px-10 border-b text-[#264164]" data-label="Qty Type">{customer.QtyType}</td>
                <td className="py-2 px-10 border-b text-[#264164]" data-label="SIH">{customer.SIH}</td>
                <td className="py-2 px-10 border-b text-[#264164]" data-label="Total Cost">{customer.TotalCost}</td>
                <td className="py-2 px-10 border-b text-[#264164]" data-label="Total Rate">{customer.TotalRate}</td>
        ...
        <div className="flex justify-end mt-4 animate-slideInUp">
          <button className="px-6 py-2 bg-purple-500 text-white rounded-md shadow hover:bg-purple-600 transition-all duration-200">+ Print Stock Detail Report</button>
        </div>
