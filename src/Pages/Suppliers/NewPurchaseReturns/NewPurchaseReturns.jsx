...
function ListGRN() {
  const [customers, setCustomers] = useState([
    { id: 1, Item: 'car', Quantity: '5', Total: '10000000', Reason: '5', Rate:'5'},
  ...
  return (
    <div className="bg-white p-6 rounded-md shadow-md w-full ">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-semibold text-[#264164] mb-1">New Purchase Return</h1>
      ...
      <div className="flex space-x-4 mt-4 mb-4">
        ...
        <div className="flex justify-end mt-4 animate-slideInUp">
          <button className="px-6 py-2 bg-purple-500 text-white rounded-md shadow hover:bg-purple-600 transition-all duration-200">+ Add New Returns</button>
        </div>
