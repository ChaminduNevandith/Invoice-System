...
function ListCustomers() {
  ...
  const [customers, setCustomers] = useState([
    { id: 1, date: '03/04/2023', CreditType: 'Invoice', CreditAmount: '1000', DebitAmount: '2000',Total: '2000',PaymentType:'Full' , PaymentMethod: 'Cash' , Chequetype: '-', ChequeDate: '-', ChequeName: '-' },
    { id: 2, date: '03/04/2023', CreditType: 'Payment', CreditAmount: '6500', DebitAmount: '0', Total: '2000',PaymentType:'Half' ,PaymentMethod: 'Online' , Chequetype: '-', ChequeDate: '-', ChequeName: '-'},
    { id: 3, date: '03/04/2023', CreditType: 'Payment', CreditAmount: '3000', DebitAmount: '1000',Total: '2000',PaymentType:'Full' , PaymentMethod: '-', Chequetype: '-', ChequeDate: '-', ChequeName: '-' },
  ...
  return (
    <div className="bg-white p-6 rounded-md shadow-md w-full ">
      <h1 className=" text-2xl font-semibold text-[#264164] mb-1">Supplier Credit Logs</h1>
      <hr className="bg-black mb-4"></hr>

      <div className="flex flex-col md:flex-row justify-between mt-[20px] mb-[50px]">
        {/* Search Bar */}
        <div className="relative mb-4 md:mb-0">
        <label className="block text-[#264164] mb-1 text-xs">Select Supplier</label>
        ...
        <table className="table-auto w-full border-collapse text-xs
          ...
          <thead>
            ...
            <th className="py-2 px-4 border-b text-[#264164]">Date</th>
              ...
              <th className="py-2 px-4 border-b text-[#264164]">Total Credit</th>
              <th className="py-2 px-4 border-b text-[#264164]">Payment Type</th>
          ...
          <tbody>
            {customers.map((customer) => (
              <tr key={customer.id} className="table-row text-gray-700 text-left bg-[#FEF9FF]">
                ...
                <td className="py-2 px-4 border-b text-[#264164]" data-label="Total Credit">{customer.Total}</td>
                <td className="py-2 px-4 border-b text-[#264164]" data-label="Payment Type">{customer.PaymentType}</td>
...
export default SupplierCreditLogs;
