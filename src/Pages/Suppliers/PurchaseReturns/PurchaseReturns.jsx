...
function DamageNoteList() {
  const [customers, setCustomers] = useState([
    { id: 1, Supplier: 'Aravinda',  date: '04/02/2023', Quantity: '10',  Reason: 'It doesn t work well with gluten-free bread—seems to prefer sourdough', total: '6,500.00', status: 'Processed' },
    { id: 2, Supplier: 'Anurada',  date: '10/10/2023', Quantity: '10',  Reason: 'These glasses make me look too mysterious—my friends cant tell if Im hiding something or just tired', total: '6,500.00', status: 'Processed' },
    { id: 3, Supplier: 'Silva',  date: '04/01/2024', Quantity: '10',  Reason: 'I thought this was a magic carpet, but it doesnt even float.', total: '6,500.00', status: 'Pending' },
  ]);
  ...
  return (
    <div className="bg-white p-6 rounded-md shadow-md w-full ">
      ...
      <div className="flex flex-col sm:flex-col md:flex-col lg:flex-row xl:flex-row 2xl:flex-row xxl:flex-row  space-x-0 md:space-x-0  lg:space-x-2 xl:space-x-2 2xl:space-x-2 xxl:space-x-2 mb-8">
        {/* Search Bar */}
          ...
          <tbody>
            {customers.map((customer) => (
              <tr key={customer.id} className="table-row text-gray-700 text-left  bg-[#FEF9FF]">
                ...
                <td className="py-2 px-4 border-b text-[#264164]" data-label="Item Count">{customer.Quantity}</td>
