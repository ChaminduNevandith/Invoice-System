...
function ListCustomers() {
  const [customers, setCustomers] = useState([
    { id: 1, Category: 'Visiting',ItemCode: '#12345' ,ProductName:'car', Brand: 'Honda', RealCost: '3,900,000.00',Cost:'4,900,000.00' , Rate:'5' , QtyType: 'KG' ,Qty:'Akila Perera', ExpireDate: '04/02/2023', Description: 'It doesn t work well with gluten-free bread—seems to prefer sourdough',  status: 'Processed' },
    { id: 2, Category: 'Visiting',ItemCode: '#12345' ,ProductName: 'Van', Brand: 'Toyota', RealCost: '1,900,000.00' ,Cost:'2,500,000.00', Rate:'3' ,QtyType: 'KG' ,Qty:'Akila Perera', ExpireDate: '04/02/2023', Description: 'These glasses make me look too mysterious—my friends cant tell if Im hiding something or just tired', status: 'Processed' },
    { id: 3, Category: 'Mobile Phone',ItemCode: '#12345' ,ProductName: 'Apple', Brand: 'Apple', RealCost: '200,000.00' , Cost:'250,000.00', Rate:'5' ,QtyType: 'G' ,Qty:'Akila Perera', ExpireDate: '04/02/2023', Description: 'I thought this was a magic carpet, but it doesnt even float.', status: 'Pending' },
  ]);
