...
function ListGRN() {
  const [customers, setCustomers] = useState([
    { id: 1, Item: 'car', Quantity: '5', Total: '10000000' },
  ...
  return (
    <div className="bg-white p-6 rounded-md shadow-md w-full ">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-semibold text-[#264164] mb-1">Add Barcodes</h1>
      ...
      <div className="relative w-[250px] sm:w-[300px] pb-5">
            <label className="block text-[#264164] mb-1 text-xs">Select GRN</label>
            <input
            type="text"
        ...
        <table className="table-auto w-full border-collapse text-xs
          ...
          <thead>
            <tr className="text-left text-gray-700 bg-[#F2F1F1] ">
                ...
                <th className="py-2 px-10 text-[#264164]">Rate (LKR)</th>
          ...
          <tbody>
            {customers.map((customer) => (
              <tr key={customer.id} className="table-row text-gray-700 text-left  bg-[#FEF9FF]">
                ...
                <td className="py-2 px-10 border-b text-[#264164]" data-label="Rate (LKR)">{customer.Rate}</td>
                ...
                <td className="py-2 px-10 border-b" data-label="Actions">
                  ...
                  <Tooltip title="Edit Barcode" placement="top" arrow>
                    ...
                    <Tooltip title="view Barcode" placement="top" arrow>
      ...
      <div className="flex space-x-4 mt-4 mb-4">
        ...
        <div className="flex justify-end mt-4 animate-slideInUp">
          <button className="px-6 py-2 bg-purple-500 text-white rounded-md shadow hover:bg-purple-600 transition-all duration-200">+ Genarate Barcode</button>
        </div>
