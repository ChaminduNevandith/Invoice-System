...
function ListCustomers() {
  ...
  const [customers, setCustomers] = useState([
    { id: 1, name: 'Akila Perera', contact: '0712345678', NIC: '123456V', ETF: '123',  status: 'Active' },
    { id: 2, name: 'Akila Perera', contact: '0712345678', NIC: '123456V', ETF: '134',  status: 'Active' },
    { id: 3, name: 'Akila Perera', contact: '0712345678', NIC: '123456V', ETF: '352', status: 'Inactive' },
  ]);
  ...
  return (
    <div className="bg-white p-6 rounded-md shadow-md w-full ">
      <h1 className="text-2xl font-semibold text-[#264164] mb-1">List Salesman</h1>
      <hr className="bg-black mb-4"></hr>

      <div className="flex flex-col sm:flex-col md:flex-col lg:flex-row xl:flex-row 2xl:flex-row xxl:flex-row justify-between mb-4">
        {/* Search Bar */}
      ...
      <div className="overflow-x-auto">
        <table className="table-auto w-full border-collapse text-xs
          ...
          <thead>
            ...
            <th className="py-2 px-4 border-b text-[#264164]">Salesman No</th>
              <th className="py-2 px-4 border-b text-[#264164]">Salesman Name</th>
              <th className="py-2 px-4 border-b text-[#264164]">Contact No</th>
              <th className="py-2 px-4 border-b text-[#264164]">NIC</th>
              <th className="py-2 px-4 border-b text-[#264164]">ETF No</th>
          ...
          <tbody>
            {customers.map((customer) => (
              <tr key={customer.id} className="table-row text-gray-700 text-left bg-[#FEF9FF] ">
                <td className="py-2 px-4 border-b text-[#264164]" data-label="Salesman No">{customer.id}</td>
                ...
                <td className="py-2 px-4 border-b text-[#264164]" data-label="NIC">{customer.NIC}</td>
                <td className="py-2 px-4 border-b text-[#264164]" data-label="ETF No">{customer.ETF}</td>
