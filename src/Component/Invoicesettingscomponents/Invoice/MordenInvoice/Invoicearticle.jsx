...
function InvoiceArticle({ articleData, selectedColor }) {
  ...
  return (
    <div className="p-6 border border-gray-300 rounded-lg bg-gray-50 shadow-md mt-6">
      {selectedColumns.showInvoice && (
        <>
          <table className="w-full border-collapse rounded-lg overflow-hidden">
            <thead>
              ...
              >
                ...
                {selectedColumns.Quantity && <th className="p-3">Quantity</th>}
          ...
          <div className="flex gap-4 mt-4">
            <button className="border border-gray-400 px-4 py-2 rounded-lg text-gray-700 bg-white hover:bg-gray-200">
