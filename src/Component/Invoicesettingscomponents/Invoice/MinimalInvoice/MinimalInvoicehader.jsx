...
function MinimalInvoiceHeader({ headerData = { showFields: {} } }) {
  if (!headerData) return <p className="text-red-500">Error: No header data provided.</p>;
    ...
    <div className="p-8 border-b border-gray-200 bg-white rounded-lg">
      <div className="grid grid-cols-2 gap-6">
        <div className="bg-blue-50 p-4 rounded-lg">
          {headerData?.showFields?.businessName && (
            <p className="text-lg font-semibold text-blue-800">{headerData?.businessName}</p>
          )}
        ...
        <div className="text-right">
          <h2 className="text-2xl font-bold text-purple-700">Asipiya</h2>
      ...
      <div className="grid grid-cols-4 gap-6 mt-6">
        <div className="bg-green-50 p-4 rounded-lg">
          <h1 className="text-3xl font-extrabold text-green-800">INVOICE</h1>
